        ...
        <div className="bg-white min-h-full flex flex-col lg:relative">
            ...
            <main className="flex-grow flex flex-col bg-white">
                ...
                <div className="flex-shrink-0 my-auto py-16 sm:py-32">
                    <p className="text-sm font-semibold text-indigo-600 uppercase tracking-wide">Not Signed In</p>
                    <h1 className="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
                    Permission Denied
                    </h1>
                    <p className="mt-2 text-base text-gray-500">Sorry, you don't have access to view this page.</p>
                    <div className="mt-6">
